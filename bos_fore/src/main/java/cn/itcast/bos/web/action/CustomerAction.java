...
public class CustomerAction extends BaseAction<Customer>{
	...
	@Action(value="customer_regist",results={@Result(name="success",type="redirect",
			location="signup-success.html"),@Result(name="input",type="redirect",
		...
		if (activecodeRedis == null || !activecodeRedis.equals(activecodeRedis)) {
			...
			if (customer.getType() == null || customer.getType() != 1) {
				...
				WebClient.create("http://localhost:9002/crm_management/services/customerService/" +
						"customer/updatetype/"+model.getTelephone()).put(null);
	...
	@Action(value="customer_login",results={@Result(name="login",location="login.html"
			,type="redirect"),@Result(name="success",location="index.html#/myhome",
			type="redirect")})
	public String login(){
		Customer customer = WebClient.create("http://localhost:9002/crm_management/services/customerService/customer/login?telephone="
